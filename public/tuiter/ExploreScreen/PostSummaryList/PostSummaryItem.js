export function PostSummaryItem (post) {
    ...
    var html="<div class='container position-relative'style=' border-top-style: none; height: 100%'><div class='row'><div class='col-10'><span style='float: left; '><a style='font-size: 13px; color: grey; text-decoration: None;' class='pt-3 pb-3 ps-3 pe-3'>"
        +topic
        ...
        +image
        +" class='pt-2' style='border-radius: 15px; width: 100%;'/></span></div></div></div>"
